/*
prioritize alternative spellings ala adplausus.txt
see accusans for example of rethinking the parse rule for {{head...}}
be careful not to add empty roots
	ala suffes.txt where {{la-noun|||}} occurs and there is no root
 */
